  ...
  class WLMOMIDiscovery < Input
    ...
    def discover
      ...
      discovery_data.each do |wclass|
        ...
        instance = {}
        instance["Timestamp"] = OMS::Common.format_time(Time.now.to_f)
        instance["Host"] = OMS::Common.get_fully_qualified_domain_name
        instance["ObjectName"] = wclass["class_name"]
        instance_collections = []
        counter_pair = {}
        counter_pair["CounterName"] = "encodedDataItem"
        counter_pair["Value"] = discovery_xml
        instance_collections.push(counter_pair)
        instance["Collections"] = instance_collections
        wrapper = {
          "DataType"=>"WLM_LINUX_INSTANCE_DATA_BLOB",
          "IPName"=>"WorkloadMonitoring",
          "DataItems"=>[instance]
        }
